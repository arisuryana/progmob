...
public class MainActivity extends AppCompatActivity {
    ...
    private void showSelectedPresident(President president) {
        ...
        moveWithDataIntent.putExtra(DetailPresident.EXTRA_REMARK, president.getRemarks());
        moveWithDataIntent.putExtra(DetailPresident.EXTRA_DESCRIPTION, president.getDescription());
        moveWithDataIntent.putExtra(DetailPresident.EXTRA_PHOTO, president.getPhoto());
